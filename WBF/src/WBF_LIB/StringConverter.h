...
public:
	...
	static void CSTR2STR(IN const CString& cstr, OUT std::string& str, UINT CodePage);
	static void STR2CSTR(IN const std::string& str, OUT CString& cstr, UINT CodePage);
	static void STR2WSTR(IN const std::string& str, OUT std::wstring wstr, UINT CodePage);
	static void WSTR2STR(IN const std::wstring wstr, OUT std::string& str, UINT CodePage);

	static std::string CSTR2STR(IN const CString& cstr, UINT CodePage);
	static CString STR2CSTR(IN const std::string& str, UINT CodePage);
	static std::wstring STR2WSTR(IN const std::string& str, UINT CodePage);
	static std::string WSTR2STR(IN const std::wstring wstr, UINT CodePage);
};
